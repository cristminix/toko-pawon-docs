...
Setelah Anda menekan tombol ini maka akan muncul form pembuatan item produk baru berikut:
 ...
 ![Create-02](images/create-product-form-multi-variant-step-01.png)
...
* **6. Area Unggah Gambar**
    ...
    ![create-product-upload-muti-images-upload](images/create-product-upload-muti-images-upload.png)
...
![create-product-form-multi-variant-step-02](images/create-product-form-multi-variant-step-02.png)
...
![create-product-form-multi-variant-step-03](images/create-product-form-multi-variant-step-03.png)
